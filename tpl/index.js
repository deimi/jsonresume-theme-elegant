...
pug_html = pug_html + "\u003Ca" + (" class=\"social-link\""+pug_attr("href", profile.url, true, false)+" target=\"_blank\" data-toggle=\"tooltip\""+pug_attr("title", resume.basics.name + " on " + profile.network, true, false)) + "\u003E";
;pug_debug_line = 18;pug_debug_filename = "pug\u002Fprofile-card.pug";
pug_html = pug_html + "\u003Ci" + (pug_attr("class", pug_classes(["fs-lg","social-link-icon","link-" + profile.label + " icon-" + profile.label], [false,false,true]), false, false)) + "\u003E\u003C\u002Fi\u003E";
...
if (resume.basics.computed_location) {
;pug_debug_line = 40;pug_debug_filename = "pug\u002Fprofile-card.pug";
